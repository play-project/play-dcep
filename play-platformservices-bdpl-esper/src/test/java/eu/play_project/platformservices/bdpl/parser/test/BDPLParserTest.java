 ...
 * 
 */
package eu.play_project.platformservices.bdpl.parser.test;
...
public class BDPLParserTest {
    ...
    public static void setUp() throws Exception { 
   	 testsLocation = BDPLParserTest.class.getResource("/bdpl/"); 
    } 
    ...
    private void testQuery(File query){
   	 ...
   	 if(query.getName().startsWith("BDPL-BrokenQuery")){
   		
   		 try {
               QueryParserFactory factory = new BDPLParserFactory();
				factory.getParser().parseQuery(content[0], null);

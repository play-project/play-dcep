 ...
 */
public class WildcardProjectionProcessor extends eu.play_project.platformservices.bdpl.parser.ASTVisitorBase {
	...
	private static class QueryVariableCollector extends eu.play_project.platformservices.bdpl.parser.ASTVisitorBase {
	...
	private static class SelectClauseCollector extends eu.play_project.platformservices.bdpl.parser.ASTVisitorBase {

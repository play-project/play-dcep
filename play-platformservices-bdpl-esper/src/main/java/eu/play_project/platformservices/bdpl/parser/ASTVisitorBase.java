...
/**
 * Base class for visitors of the BDPL AST. The visitor just goes further to children nodes. 
 * 
 * @author arjohn, ningyuan
 */
public abstract class ASTVisitorBase implements SyntaxTreeBuilderVisitor {
		...
		@Override
		public Object visit(ASTHistoricalEventQuery node, Object data)
				throws VisitorException{
			return node.childrenAccept(this, data);
		}

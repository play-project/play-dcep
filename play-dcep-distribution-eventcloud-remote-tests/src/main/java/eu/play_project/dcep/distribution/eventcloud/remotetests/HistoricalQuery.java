...
//		//EpSparqlQuery query = generateQuery(args[0]);
//		EpSparqlQuery query = generateQuery(queryString) ; 
...
//	
//
//	public static EpSparqlQuery generateQuery(String queryString){
...
//		
//		EpSparqlQuery epQuery = new EpSparqlQuery(new QueryDetails("'id_1234'"), eleGenerator.getEle());

 ...
 */
public class Dcep implements DcepApi<CompoundEvent>, ComponentInitActive, ComponentEndActive,
		Serializable {

	private static final long serialVersionUID = 100L;
	private DcepNodeApi<CompoundEvent> dEtalisTest;
	private DcepMonitoringApi dEtalisMonitoring;
	private DcepManager dcepManager;
	private DcepNodeConfiguringApi<CompoundEvent> configApi;
	...
	private boolean init() {
		...
		if (init) {
			...
			try {
				...
				dEtalisTest = ((DcepNodeApi<CompoundEvent>) dEtalis
				...
				configApi = ((DcepNodeConfiguringApi<CompoundEvent>)dEtalis.getFcInterface(DcepNodeConfiguringApi.class.getSimpleName()));
	...
	public void configNodeInstance(DcepNodeConfiguringApi<CompoundEvent> configApi) throws DcepManagementException {

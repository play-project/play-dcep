...
//import eu.play_project.querydispatcher.epsparql.Test.helpers.FilterExpressionCodeGenerator;

public class EpSarqlEle01Test {
	...
	public void startParser() throws InterruptedException {
		String queryString = getQuery("play-epsparql-m12-jeans-example-query.eprq")[0];
